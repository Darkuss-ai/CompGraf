...
namespace Tao_OpenGL_Initialization_Test
{
    public partial class Form1 : Form
    {
        ...
        double ep, ek, v;
        double vmax, ymax, ymin, xmax, xmin;
        ...
        private void DrawAnT1(AnT_axes ant)
        {
            ...
            ant.Xmin = (int)xmax;
            ant.Ymin = (int)ymax;
            Gl.glTranslated(ant.Xmin, ant.Ymin, ant.z - (ymax + xmax) / 2);
            ant.Xmin = saveX;
            ant.Ymin = saveY;
        ...
        private void CalcMax()
        {
            ...
            xmax = 2 * v0 * v0 * Math.Sin(angle) * Math.Cos(angle) / g;
            ymax = v0 * v0 * Math.Sin(angle) * Math.Sin(angle) / (2 * g);
        ...
        private void DrawGrid(AnT_axes ant)
        {
            ...
            for (int ax = ant.Xmin - 10; ax < ant.Xmax + xmax; ax++)
                for (int bx = ant.Ymin - 10; bx < ant.Ymax + ymax; bx++)
                    Gl.glVertex2d(ax, bx);
            Gl.glEnd();
        }
        ...
        { 
            ...
            Gl.glVertex2d(0, ant.Ymin - 10);
            Gl.glVertex2d(0, ant.Ymax + ymax);
            Gl.glEnd();
            Gl.glBegin(Gl.GL_LINES);
            Gl.glVertex2d(ant.Xmin - 10, 0);
            Gl.glVertex2d(ant.Xmax + xmax, 0);
